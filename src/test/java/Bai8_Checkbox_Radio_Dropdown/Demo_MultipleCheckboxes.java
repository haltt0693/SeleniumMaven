...
public class Demo_MultipleCheckboxes extends BaseTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        List<WebElement> nameOfCheckbox = driver.findElements(By.xpath("//div[@id='dashboard-options']//label"));

        //Duyệt từng checkbox trong list element
        for (int i = 0; i < listCheckbox.size(); i++) {
            System.out.println("Checkbox thứ " + (i + 1) + ": " + listCheckbox.get(i).isSelected() + " AND value = " + nameOfCheckbox.get(i).getText());
        }
