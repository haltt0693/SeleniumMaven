...
//        driver.findElement(By.xpath(LocatorsCRM.inputCompany)).sendKeys("[Ha Le] Company ABC 003");
...
//        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath(LocatorsCRM.menuCustomer)).click();
        driver.findElement(By.xpath(LocatorsCRM.inputSearchCustomer)).sendKeys("[ha le]");
        System.out.println("Created Customer is displayed: " + driver.findElement(By.xpath(LocatorsCRM.selectAnyCustomer)).isDisplayed());
        System.out.println("Name of First Customer: " + driver.findElement(By.xpath(LocatorsCRM.selectAnyCustomer)).getText());
        driver.findElement(By.xpath(LocatorsCRM.selectAnyCustomer)).click();
